document.addEventListener("DOMContentLoaded", function () {
    ...
    function displayCheckoutItems() {
        ...
        if (cart.length === 0) {
            checkoutItems.innerHTML = `<p style="font-size:14px;">Your cart is empty.</p>`;
            checkoutSubtotal.textContent = "Rs. 0";
            checkoutDelivery.textContent = "Rs. 0";
        ...
        checkoutDelivery.textContent = delivery === 0 ? "Free" : `Rs. ${delivery.toLocaleString()}`;
        ...
        checkoutForm.addEventListener("submit", function (event) {
            ...
            if (paymentMethod === "card") {
                const pendingOrder = {
                    ...
                    paymentMethod: "card",
                    items: cart,
                    subtotal: checkoutSubtotal.textContent,
                    delivery: checkoutDelivery.textContent,
            ...
            localStorage.removeItem("nestoraCart");
